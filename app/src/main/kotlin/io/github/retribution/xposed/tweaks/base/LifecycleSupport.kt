package io.github.retribution.xposed.tweaks.base
...
val lifecycleSupport by tweak {
    val reactActivity = classLoader.loadClass(RetributionConstants.TARGET_ACTIVITY)
...
/** Tweak or plugin code should use [io.github.retribution.xposed.api.HostScope.withAppContext] instead. */
...
/** Tweak or plugin code should use [io.github.retribution.xposed.api.HostScope.withAppActivity] instead. */
