...
import io.github.retribution.xposed.tweaks.plugins.internal.RESERVED_DEPENDENCY_IDS
        ...
        ZipFile(spool).use { zip ->
            val manifestEntry = zip.getEntry(MANIFEST_FILE)
                ?: throw PluginException(
                    ...
                    "Not a Retribution plugin ZIP: missing $MANIFEST_FILE",
                )

            val manifest = try {
                RetributionJson.decodeFromString(
