...
import io.github.retribution.plugins.VersionRange
import io.github.retribution.xposed.RetributionJson
import io.github.retribution.xposed.tweaks.plugins.ExternalDependency
import io.github.retribution.xposed.tweaks.plugins.requireValidPluginId
import io.github.retribution.xposed.tweaks.plugins.validatedPluginIcon
...
internal fun parseRepoIndex(json: String, repoUrl: String, log: Logger): RepoIndex {
    val raw = RetributionJson.decodeFromString<RepoIndex>(json)
