...
import io.github.retribution.plugins.API_DEPENDENCY_ID
import io.github.retribution.plugins.DISCORD_DEPENDENCY_ID
...
class DiscoveryFailureTest {
    private val dataDir: File = Files.createTempDirectory("Retribution-discovery-test").toFile()
